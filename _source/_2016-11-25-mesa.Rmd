...
The Middle East Studies Association (MESA) is celebrating its 50th anniversary this year. Although it is not as large as such associations as AAR and AHA, it is very dear to most of us who are engaged in the study of Middle East. The anniversary seems like a good reason to reflect on the state of the field and communities of scholars that MESA brought together over these years. Those who attended the annual meeting in Boston just a couple of weeks ago must have seen an attempt to visualize academic genealogies of scholars of Middle East, which soundss like a very interestin idea, but will take forever to realize. At the moment the genealogy looks like a lot of snowflakes (here is Franz Rosenthal's [snowflake of students](../projects/mesa_network/genealogy.jpg)),[^fr] but we all realize that the real life is way more complicated and more interesting than that (`<hint>MESA should add another field to academic profiles, where we'll need to provide the name of our adviser(s?!)—or, better, the entire dissertation committee</hint>`—then we will be able to recreate a living genealogy of the field with all its  complexities and subtleties).

While the genealogy project is too far away from its maturity, we do have some other interesting data through which we can get a glimpse into the academic community that grew around MESA: we can use programs of annual meetings--in combination with academic profiles of MESA members (and, later abstracts of their papers)--to gauge whether and how we are connected with each other across the field, how we form collegial communities and maintain them, and how these communities take new shapes in reaction to internal developments in the academy and to external political and social factors. The program data is limited in many ways, as it does not capture such connections as who attends what panels, who criticizes/supports whom, nor does it nowhere close to revealing who we hang out with <strike>instead of</strike> between panels at the most attended and beloved area of the conference. Additionally, only a limited number of programs is relatively accessible at the moment and our insight can go back in time only 7 years (2009--2016; all data used below is openly available at the official [MESA Website](http://mesana.org/)).
...
Reports summarize aggregated formal descriptions that the members of MESA provide in their academic profiles: disciplines, subfields, geographical areas of specialization, working languages, and degrees.

# List of community reports

- [#1: Modern Politics](#community-1-modularity-`r modTable$modCount[1]`)
- [#2: Ottoman History](#community-2-modularity-`r modTable$modCount[2]`)
